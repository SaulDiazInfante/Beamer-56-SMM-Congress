...
NAMETAR = "$(NAMETAR1)_BEAMER_56-SMM_congress.tar.gz"
NAMEZIP = "$(NAMETAR1)_BEAMER_56-SMM_congress.zip"
#main.aux
pdflatex:main.tex
	/usr/local/texlive/2023/bin/x86_64-linux/pdflatex --synctex=1 main.tex
	sh biblio.sh
	# /usr/local/texlive/2023/bin/x86_64-linux/bibtex main.aux
	/usr/local/texlive/2023/bin/x86_64-linux/pdflatex --synctex=1 main.tex
	/usr/local/texlive/2023/bin/x86_64-linux/pdflatex --synctex=1 main.tex
